        	...
        	<div class="ha-header-front">
                ...
                <div class="grid-20 tablet-grid-50 mobile-grid-50 <?php echo $logo_push; ?>">
					...
					<?php if ( get_theme_mod( 'ut_site_logo' ) ) : ?>
                        ...
                        <div class="site-logo">
                            <a href="http://192.185.88.244/~devrilia" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img data-altlogo="<?php echo $alternate_logo; ?>" src="<?php echo $sitelogo; ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></a>
							<!-- radan: url code replaced with fixed address above /* <?php echo esc_url( home_url( '/' ) ); ?>*/ -->
                        </div>
